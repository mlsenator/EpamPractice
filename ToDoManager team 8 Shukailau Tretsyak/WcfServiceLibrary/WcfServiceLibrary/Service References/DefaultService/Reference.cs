...
namespace WcfServiceLibrary.DefaultService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="DefaultService.IToDoManager")]
    public interface IToDoManager {
        ...
        WcfServiceLibrary.DefaultService.ToDoItem[] GetTodoList(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/GetTodoList", ReplyAction="http://tempuri.org/IToDoManager/GetTodoListResponse")]
        System.Threading.Tasks.Task<WcfServiceLibrary.DefaultService.ToDoItem[]> GetTodoListAsync(int userId);
        ...
        void UpdateToDoItem(WcfServiceLibrary.DefaultService.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/UpdateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/UpdateToDoItemResponse")]
        System.Threading.Tasks.Task UpdateToDoItemAsync(WcfServiceLibrary.DefaultService.ToDoItem todo);
        ...
        void CreateToDoItem(WcfServiceLibrary.DefaultService.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/CreateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/CreateToDoItemResponse")]
        System.Threading.Tasks.Task CreateToDoItemAsync(WcfServiceLibrary.DefaultService.ToDoItem todo);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IToDoManagerChannel : WcfServiceLibrary.DefaultService.IToDoManager, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ToDoManagerClient : System.ServiceModel.ClientBase<WcfServiceLibrary.DefaultService.IToDoManager>, WcfServiceLibrary.DefaultService.IToDoManager {
        ...
        public WcfServiceLibrary.DefaultService.ToDoItem[] GetTodoList(int userId) {
            return base.Channel.GetTodoList(userId);
        }
        
        public System.Threading.Tasks.Task<WcfServiceLibrary.DefaultService.ToDoItem[]> GetTodoListAsync(int userId) {
            return base.Channel.GetTodoListAsync(userId);
        }
        
        public void UpdateToDoItem(WcfServiceLibrary.DefaultService.ToDoItem todo) {
            base.Channel.UpdateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task UpdateToDoItemAsync(WcfServiceLibrary.DefaultService.ToDoItem todo) {
            return base.Channel.UpdateToDoItemAsync(todo);
        }
        
        public void CreateToDoItem(WcfServiceLibrary.DefaultService.ToDoItem todo) {
            base.Channel.CreateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task CreateToDoItemAsync(WcfServiceLibrary.DefaultService.ToDoItem todo) {
